...
// --- Available Models (Example List) ---
// Replace with models available via your OpenRouter setup
...
const PromptCompressionView: React.FC<PromptCompressionViewProps> = ({ apiClient }) => {
  ...
  const handleGenerate = useCallback(async (
    ...
    try {
      ...
      const response = await fetch(`/api/generate`, { // Use fetch for streaming API
        method: 'POST',
        headers: {
