...
function Dashboard({ session }: DashboardProps) {
  const [selectedFeature, setSelectedFeature] =
    useState<FeatureKey>('model-selector'); // Default to model selector
  ...
  const getCurrentFeatureTitle = () => {
    switch (selectedFeature) {
      ...
      case 'ranker':
        return 'Product Ranker';
      case 'model-selector':
        return 'Intelligent Model Selection Chat';
      case 'prompt-compression':
        return 'Prompt Compression Demo'; // --- NEW Title ---
      default:
        return 'Dashboard';
    }
  };
        ...
        <ListItem disablePadding>
          ...
          >
            <ListItemIcon>
              <AutoAwesomeIcon
                color={
                  selectedFeature === 'model-selector' ? 'primary' : 'action'
                }
              />
            </ListItemIcon>
